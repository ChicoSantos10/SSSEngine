...
namespace std
{
    ...
    SSSENGINE_GLOBAL
    constexpr partial_ordering partial_ordering::less(Impl::Ordering::less);

    SSSENGINE_GLOBAL
    constexpr partial_ordering partial_ordering::equivalent(Impl::Ordering::equivalent);

    SSSENGINE_GLOBAL
    constexpr partial_ordering partial_ordering::greater(Impl::Ordering::greater);

    SSSENGINE_GLOBAL
    constexpr partial_ordering partial_ordering::unordered(Impl::Ordering::unordered);
    ...
    SSSENGINE_GLOBAL
    constexpr weak_ordering weak_ordering::less(Impl::Ordering::less);

    SSSENGINE_GLOBAL
    constexpr weak_ordering weak_ordering::equivalent(Impl::Ordering::equivalent);

    SSSENGINE_GLOBAL
    constexpr weak_ordering weak_ordering::greater(Impl::Ordering::greater);
    ...
    SSSENGINE_GLOBAL
    constexpr strong_ordering strong_ordering::less(Impl::Ordering::less);

    SSSENGINE_GLOBAL
    constexpr strong_ordering strong_ordering::equal(Impl::Ordering::equivalent);

    SSSENGINE_GLOBAL
    constexpr strong_ordering strong_ordering::equivalent(Impl::Ordering::equivalent);

    SSSENGINE_GLOBAL
    constexpr strong_ordering strong_ordering::greater(Impl::Ordering::greater);
